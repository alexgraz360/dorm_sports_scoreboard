...
bare = cal(["UID:bare", TZ + "20260914T180000", "SUMMARY:No room"])
check("missing location keeps the placeholder", W._parse_ical_today(bare, datetime(2026, 9, 14, 6, 0, tzinfo=E))[0]["room"], chr(8212))
